...
public class FindUnUsedAssetWindow : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        EditorGUI.DrawRect(new Rect(0, 70, position.width, 2), Color.gray);
        EditorGUI.DrawRect(new Rect(winWidthHalf - 1, 70, 2, position.height - 70), Color.gray);
