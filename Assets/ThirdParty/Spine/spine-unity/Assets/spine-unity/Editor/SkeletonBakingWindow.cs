...
namespace Spine.Unity.Editor
{
    ...
    public class SkeletonBakingWindow : EditorWindow
    {
        ...
        // 自定义
        /**************************************************/
        const string _InputDir = "Assets/Spine";
        const string _OutputDir = "Assets/Character";
        ...
        //[MenuItem("Spine/烘焙全部", false, 1)]
        static void BakeAll()
        {
            Bake( false );
        }

        [MenuItem( "Spine/烘焙新增（如需更新，手动删除旧的）", false, 2 )]
        static void BakeNew()
        {
            Bake( true );
        }
